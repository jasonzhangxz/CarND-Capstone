...
MAX_DECEL = 0.5 #maximum deceleration value
...
class WaypointUpdater(object):
    ...
    def get_closest_waypoint_idx(self):
        ...
        #check whether it is ahead or behind
    ...
    def decelerate_waypoints(self,waypoints,closest_idx):
        ...
        for i,wp in enumerate(waypoints):
            ...
            stop_idx = max(self.stopline_wp_idx - closest_idx - 3, 0) # 3 points back from stopline
